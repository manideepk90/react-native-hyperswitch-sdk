...
@module("../spec/NativeHyperswitchSdk") external hyperswitchSdk: 'a = "default"
...
@send  
external presentPaymentSheetNative: ('a, 'b) => Js.Promise.t<Js.Json.t> = "presentPaymentSheet"
...
@genType
let initPaymentSession = (initPaymentSessionParams: HyperTypes.initPaymentSheetParamTypes): Js.Promise.t<'a> => {
...
let presentPaymentSheet = (sessionParams: HyperTypes.sessionParams): Js.Promise.t<HyperTypes.responseFromNativeModule> => {
  hyperswitchSdk->presentPaymentSheetNative(sessionParams->HyperCommonTypes.parser)
