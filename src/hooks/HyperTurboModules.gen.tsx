...
export const initPaymentSession: <a>(initPaymentSessionParams:HyperTypes_initPaymentSheetParamTypes) => Promise<a> = HyperTurboModulesJS.initPaymentSession as any;
