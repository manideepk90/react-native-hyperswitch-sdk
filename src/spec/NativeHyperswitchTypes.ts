...
export type headlessConfirmResponseType = {
  readonly message: string;
  readonly type_: string;
};
...
export type customerConfiguration = {
  ...
  readonly ephemeralKeySecret: undefined | string;
};
...
export type phone = {
  ...
  readonly country_code: undefined | string;
};
...
export type hyperProviderTypes = {
  readonly publishableKey: string;
  readonly customBackendUrl?: undefined | string;
};
